...
import { Button, CardActions, CardContent, Grid, Card, Typography, TextField, Tabs, Tab, Box } from "@mui/material"
            ...
            <Card sx={{ minWidth: 275, height: "max-content" }}>
                ...
                <Box sx={{ width: '100%' }}>
                    <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                        <Tabs centered
                            onChange={(event, i: number) => { this.setState({ selectedTab: i }) }}
                        ...
                        <form onSubmit={this.handleSubmit}>
                            <CardContent>
                                ...
                                <TextField required
                                    ...
                                    onChange={(e) => { this.handleEducationFormChange(e, "school") }} />
                            ...
                            <CardActions>
                                <Button size="small" type="submit">Create Account</Button>
                            </CardActions>
                        </form>
